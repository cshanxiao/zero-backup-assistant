...
class SystemTrayDemo(QDialog):
    ...
    def createMessageGroupBox(self):
        ...
        self.cmbType.addItem('无类型', QSystemTrayIcon.MessageIcon.NoIcon)
        self.cmbType.addItem(self.style().standardIcon(QStyle.StandardPixmap.SP_MessageBoxInformation),
                             '信息', QSystemTrayIcon.MessageIcon.Information)
        self.cmbType.addItem(self.style().standardIcon(QStyle.StandardPixmap.SP_MessageBoxWarning),
                             '警告', QSystemTrayIcon.MessageIcon.Warning)
        self.cmbType.addItem(self.style().standardIcon(QStyle.StandardPixmap.SP_MessageBoxCritical),
                             '错误', QSystemTrayIcon.MessageIcon.Critical)
